# REQ-1019: implementation notes

**Requirement**

Notify all signers by email when an account is closed. Retain proof of each notification for 7 years for audit.

**Planned tasks**

- [ ] Analyze requirement and confirm dependencies and risks
- [ ] Implement: Notify all signers by email when an account is closed.
- [ ] Implement: Retain proof of each notification for 7 years for audit.
