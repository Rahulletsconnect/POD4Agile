# REQ-1005: implementation notes

**Requirement**

Allow a customer to schedule a recurring payment. Send a reminder 24 hours before each payment.

**Planned tasks**

- [ ] Analyze requirement and confirm dependencies and risks
- [ ] Implement: Allow a customer to schedule a recurring payment.
- [ ] Implement: Send a reminder 24 hours before each payment.
